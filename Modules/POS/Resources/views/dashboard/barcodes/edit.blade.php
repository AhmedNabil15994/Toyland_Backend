...
@section('title', __('pos::dashboard.barcode.routes.update'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('pos::dashboard.barcode.routes.update')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post"
                      enctype="multipart/form-data" action="{{route('dashboard.barcode.update',$model->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                        ...
                        <div class="col-md-9">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active fade in" id="global_setting">
                                    {{--                                    <h3 class="page-title">{{__('pos::dashboard.barcode.form.tabs.general')}}</h3>--}}
