    ...
    <div>
           <div class="card bg-white list-products">
                                                    ...
                                                    <table  class="table " >
                                                        ...
                                                        <tbody class="table-items">
                                                            <tr v-for="(order, index) in ordersFinal" :key="`orders_${order.id}`">
                                                                ...
                                                                <td>{{order.user ? order.user.name : "unknow"}}</td>
                                                                <td>
                                                                    <span v-if="order.order_status.code == 2">
                                                                        (<del style="color:red">{{ order.total_backup}}</del>)
                                                            ...
                                                            <tr>
                                                                <th scope="row">
                                                                    <div class="product-list d-flex">
                                                                        <div class="p-img">
                                                                            <img class="img-fluid" src="/poss/images/2.jpg" alt="" />
                                                                        </div>
            ...
            <refund-modal 
             ...
             />
            <div class="d-none">
                     <invoice :order="printItem" :user="user" :settings="settings"/>
             </div>
    </div>
</template>
