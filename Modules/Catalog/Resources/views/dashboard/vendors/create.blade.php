...
@section('title', __('catalog::dashboard.vendors.create.title'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{ __('catalog::dashboard.vendors.create.title') }}</a>
                    </li>
                </ul>
            </div>
                                            ...
                                            <ul class="nav nav-pills nav-stacked">
                                                <li class="active">
                                                    <a href="#global_setting" data-toggle="tab">
                                                        {{ __('catalog::dashboard.vendors.create.form.general') }}
                                                    </a>
                                                </li>
                        ...
                        <div class="col-md-9">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active fade in" id="global_setting">
                                    {{-- <h3 class="page-title">{{ __('catalog::dashboard.vendors.create.form.general') }}
                                    </h3> --}}
                                    <div class="col-md-10">
                                                ...
                                                <div id="first_{{ $code }}"
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-2">
                                                            {{ __('catalog::dashboard.vendors.create.form.title') }}
                                                            - {{ $code }}
                                                        </label>
                                                        <div class="col-md-9">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-2">
                                                            {{ __('catalog::dashboard.vendors.create.form.description') }}
                                                            - {{ $code }}
                                                        </label>
                                                        <div class="col-md-9">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{ __('catalog::dashboard.vendors.create.form.status') }}
                                            </label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{ __('catalog::dashboard.vendors.create.form.image') }}
                                            </label>
                                            <div class="col-md-9">
