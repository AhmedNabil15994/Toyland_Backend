        ...
        <div class="page-content">
            ...
            <div class="row">
                <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post"
                      enctype="multipart/form-data" action="{{route('dashboard.ages.update',$age->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                        ...
                        <div class="col-md-9">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active fade in" id="global_setting">
                                    {{--                                    <h3 class="page-title">{{__('catalog::dashboard.ages.form.tabs.general')}}</h3>--}}
                                    ...
                                    <div class="tab-content px-1 pt-1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="title[{{$code}}]"
                                                                   ...
                                                                   value="{{ $age->getTranslation('title',$code) }}">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('catalog::dashboard.ages.form.image')}}
                                                </label>
                                                <div class="col-md-9">
                                                    @include('core::dashboard.shared.file_upload', ['image' => $age->image])
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('catalog::dashboard.ages.form.status')}}
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="checkbox" class="make-switch" id="test"
                                                           data-size="small"
                                                           name="status" {{($age->status == 1) ? ' checked="" ' : ''}}>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
