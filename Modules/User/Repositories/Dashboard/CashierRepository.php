...
class CashierRepository
{
     ...
     */
    public function getAllCashiers($order = 'id', $sort = 'desc')
    {
        $users = $this->user->whereHas('roles.perms', function ($query) {
            $query->where('name', 'cashiers_access');
    ...
    {
        $user = $this->user->withDeleted() /* ->with('branch') */->find($id);
        return $user;
    }
    ...
    public function create($request)
    {
        ...
        try {
            ...
            $image = $request['image'] ? Attachment::addAttachment($request->file('image'), 'cashiers') : '/uploads/users/user.png';
    ...
    public function update($request, $id)
    {
        ...
        try {
            ...
            $image = $request['image'] ? Attachment::updateAttachment($request->file('image'), $user->image, 'cashiers') : $user->image;
    ...
    {
        $query = $this->user/* ->with('branch') */->where('id', '!=', auth()->id())->whereHas('roles.perms', function ($query) {
