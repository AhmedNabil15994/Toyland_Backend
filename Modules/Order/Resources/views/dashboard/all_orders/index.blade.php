            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'order_status_id', className: 'dt-center', orderable: false},
                        {data: 'payment_type', className: 'dt-center', orderable: false},
                        {data: 'payment_status', className: 'dt-center', orderable: false},
