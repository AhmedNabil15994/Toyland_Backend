...
@section('title', __('order::dashboard.orders.custom_orders.title'). ' | '. $orderStatus->title)
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{ __('order::dashboard.orders.custom_orders.title'). ' | '. $orderStatus->title }}</a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">
                                    {{ __('order::dashboard.orders.custom_orders.title'). ' | '. $orderStatus->title }}
                                </span>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ __('order::dashboard.orders.datatable.payment_type') }}</th>
                                        <th>{{ __('order::dashboard.orders.datatable.payment_status') }}</th>
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.custom_orders.datatable', $orderStatus->flag)) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                    ...
                    buttons: [{
                        ...
                        },
                        {
                            ...
                            url: "{{url(route('dashboard.custom_orders.export' , ['flag' => $orderStatus->flag, 'pdf' => 'print']))}}",
                            data: {
                                req: data,
                            },
                            exportOptions: {
                        ...
                        },
                        {
                            ...
                            url: "{{url(route('dashboard.custom_orders.export' , ['flag' => $orderStatus->flag, 'pdf' => 'pdf']))}}",
                            data: {
                                req: data,
                            },
                            exportOptions: {
                        ...
                        },
                        {
                            ...
                            url: "{{url(route('dashboard.custom_orders.export' , ['flag' => $orderStatus->flag, 'pdf' => 'excel']))}}",
                            data: {
                                req: data,
                            },
                            exportOptions: {
